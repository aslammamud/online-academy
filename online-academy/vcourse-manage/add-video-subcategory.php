        ...
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                <div id="msg-container" class="card pl-4 pt-4 pb-2 bg-light">
                    <div class="row" style="background: #89bf6e;    padding: 10px 10px;">
                        <div class="col-md-6">
...
if (mysqli_query($con, $insert_query)) {
  ...
  echo gen_notifi('Sucessfully Created a Sub category: '.$sub_catg_title.'!','alert-success');     
} else {
...
echo '
<a href="add-video-subcategory.php?del_confirm='.$_GET['del'].'" class="item_delete_button btn btn-sm btn-danger mt-2">
Yes</a>';
echo ' <a href="add-video-subcategory.php" class="item_delete_button btn btn-sm btn-success mt-2">NO</a>';
}

if(isset($_GET['del_confirm'])){
$del_confirm = $_GET['del_confirm'];
$delete = "DELETE FROM instructor_video_sub_cat WHERE ins_vdo_sb_ct_id = '$del_confirm'";
$result =  mysqli_query($con, $delete);  
echo gen_notifi('Deleted successfully!','alert-info');  
echo reloader('add-video-subcategory.php',1000);
}
?>    
                                   ...
                                   <div class="row justify-content-center" data-select2-id="12">
                                                <div class="col-xl-10" data-select2-id="11">
                                                   ...
                                                   <div class="form-group row mb-3" data-select2-id="10">
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        <label class="col-md-3 col-form-label" for="catg_description"> সাব ক্যাটেগরির ডেসক্রিপ্টশন *</label>
                                                        <div class="col-md-9">
                                                            <textarea name="sub_catg_description" id="catg_description" class="form-control" rows="4" required></textarea>
                                                        </div>
                                                    </div>
                                    ...
                                    <table id="course-datatable-server-side" class="table table-striped dt-responsive nowrap dataTable no-footer dtr-inline collapsed" width="100%" data-page-length="25" role="grid" aria-describedby="course-datatable-server-side_info" style="width: 100%;">
                                        ...
                                        ?>
                                            <tr role="row" class="odd bg-white">
                                                ...
                                                <td>
                                                    <img src="<?php echo $site_link?>/upload/instructor-video-sub-categories/<?=$data['ins_vdo_sb_ct_image']; ?>" alt="<?=strtolower($data['ins_vdo_sb_ct_title']);?>" height="30px" width=30px>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                 <a href="add-video-subcategory.php?del=<?=$data['ins_vdo_sb_ct_id']; ?>" 
