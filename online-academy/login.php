...
if(isset($_POST['submit'])) {
	...
	if(empty($_POST['phone'])){
		...
		if(preg_match("/^(?:\+88|01)?(?:\d{11}|\d{13})$/",$_POST['phone'])){		
            ...
            $step_three_crypt = crypt($step_two_sha1,abc);
				...
				foreach($result as $user){
					if( $user['user_phone']== $phone){
						...
						if($count_authentic_user>0){
							...
							echo  reloader('student/index.php',0);
...
<div class="checkoutbox">
	<div class="contacta">
		...
		<div style="text-align:right; font-size: 12px"><a href="instructor/login.php" style="color: #25a53b;">আপনি কি একজন ইন্সট্রাক্টর? তাহলে এখানে <p class="badge badge-warning p-2"> লগিন করুন </p></a></div>
	</div>
</div>
</center>
