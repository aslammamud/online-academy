...
<section id="title">
	<center><div><h3>কিভাবে পরীক্ষা দিবেন ?</h3></div></center>
</section>
<style type="text/css">
	#title div{
		width: 100%;
...
<div id="accordion" style="width: 100%; border-radius: 10px; background-color: #6FD742;">
  ...
  <p  style="margin-bottom: 50px; margin-left: 30px;"><h3>এই লিংকে যাবেন প্রথমে</h3>
...
<div id="accordion" style="width: 100%; border-radius: 10px; background-color: #6FD742;">
  ...
  <div class="card p-5">
    ...
    <div >
      <div class="card-body" >
       <h3 style="margin-left: 30px;"></h3>
  <p  style="margin-bottom: 50px;margin-left: 30px;">Fill your shopping cart by clicking “Add to Cart” or “Add to Bag” on each item you want to purchase. When you’re done, click the “Checkout”</p>
      </div>
    </div>
  </div>
