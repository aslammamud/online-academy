...
$total_courses = getEnrolledCoursesByStudent($std_id,0);
?>
<div class="container">
    <div class="row my-4">
...
?>
          ...
          <div class="col-sm-4 col-md-4">
            <div class="card bg-light">
              <img class="card-img-top" src="../upload/instructor-made-courses/<?php echo $course['ins_mc_image']; ?>" alt="img" height="200px" width="300px">
