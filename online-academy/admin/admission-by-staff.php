...
<h4> DAY: <b><?php echo $Selectet_day?></b> | MONTH: <b><?php echo date("F", mktime(0, 0, 0, $Selectet_month, 10))?> (<?php echo $Selectet_month?>)</b> | YEAR: <b><?php echo $Selectet_year?></b></h4>
                <table class="table table-hover">
                    <thead style="background:#434344;">
                        <tr>
                           ...
                           <!--<th>VIEW DETAILS</th>-->
							 <th>TOTAL AD</th>
                            <th style="background:#70d743;"><?php echo date("F", mktime(0, 0, 0, $Selectet_month, 10))?> (ADM)</th>
                            <th style="background: #70d743;"><?php echo date("F", mktime(0, 0, 0, $Selectet_month, 10))?> (FORM) </th>
                            <th>TODAY AD</th>
							 <th>TODAY FORM</th>
							 <th>SUCCESS RATE</th>
							 <th>FAILURE RATE</th>
	...
	$admission_this_month = student_count_author($key,'Month','dayunset',$Selectet_month,$Selectet_year);
	 $form_this_month = student_count_author($key,'form_this_month');					 
