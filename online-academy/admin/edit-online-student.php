            ...
            <div class="container-fluid">
             ...
             <?php
			  ...
			  if(isset($_POST['submit'])){
				...
				$form_facebook = $_POST['form_facebook'];
				...
				st_education = ?
				Where st_id = ?");
				$stmt2->bind_param('sssssssssssssssss',$form_name,$form_father_name,$form_mother_name,$form_email,$form_Phone,$form_address_Student,$form_Birth,$form_nid,$form_Course_Name,$form_Course_Duration,$form_facebook,$form_sex,$form_Note_Student,$form_batch_number,$form_Reference_Name,$form_education,$st_id);
				if ($stmt2->execute()) {
				echo ntf('Uploaded!',1);
				echo reloader($site_link.'/admin/edit-online-student.php?st='.$st_id.'',1000);
				}
			...
			echo '</select>';
				...
				<div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input name="form_facebook" value="<?php echo $row ['st_facebook'];?>" type="text" placeholder=""  required="" class="form-control" aria-required="true" />
                    </div>
                  </div>
