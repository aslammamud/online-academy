...
.modal-backdrop {
  z-index: 1;
      ...
      <div class="row" style="color:black;">
		...
		<center><h2>Batch - <?php echo $getbatch ?> | <a href="<?php echo $site_link ?>/admin/manage-batchs-support.php">BACK</a></h2></center>
...
<h3 style="text-align:center;padding:10px;">Student info</h3>	
