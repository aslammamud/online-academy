...
$select_query = "SELECT * FROM orders WHERE order_status = 'On delivery'";
$select_ondelivery_order_info = mysqli_query($con, $select_query);
?>
    ...
    <div class="sl-mainpanel">
      ...
      <nav class="breadcrumb sl-breadcrumb" aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">ondelivery order</li>
        </ol>
      </nav>
          ...
          <div class="row gutters-10">
            <div class="col-md-3">
                <div class="bg-info text-white rounded-lg mb-4 overflow-hidden">
                  <div class="px-3 pt-3">
                    <div class="h3 fw-700"><?= $select_ondelivery_order_info->num_rows ?></div>
            ...
            <tbody>
                ...
                <?php
                  foreach($select_ondelivery_order_info as $order_info){
                    ?>
                      <tr>
                        <td id ="customer_id" class="text-dark"><?=$order_info['id']?></td>
