<?php include('header.php') ?>
        <div class="content">
			...
			//echo  check_batch_fillup('601',1);
				...
				$st_note = $row['st_note'];
				$st_name = $row['st_name'];
				$std_reg = $row['st_registration_number'];
			...
			<div class="alert alert-danger" role="alert">
			  ...
			  <hr></div>';
				...
				echo reloader2(''.$site_link.'/admin/edit-invoice.php?st='.$st_id.'',1000);
				}else {
   ...
   <div class="col-sm-12">
				...
				<div class="row">
                      <div class="col-sm-6">
                       <a href="<?php echo $site_link?>/download-form.php?st=<?php echo $st_id?>" target="_blank" class="btn btn-block btn-dark btn-theme-colored btn-sm mt-20 pt-10 pb-10 md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">
					   DOWNLOAD FORM</a>
                      </div>
                      <div class="col-sm-6">
                       <a href="<?php echo $site_link?>/st-invoice.php?inv=<?php echo $std_reg?>" target="_blank" class="btn btn-block btn-dark btn-theme-colored btn-sm mt-20 pt-10 pb-10 md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">
					   VIEW INVOICE</a>
                      </div>
                    </div>
