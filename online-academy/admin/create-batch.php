...
IF(is_admin() OR $di_stf_desiganation == 11 or $di_stf_desiganation == 5 or $di_stf_desiganation == 7){
	...
	$cnt = mysqli_num_rows($queryc);
	 ...
	 if($cnt < 1){
		 ...
		 `b_terget`,`b_visibility`,`b_status`)
						...
						//echo reloader(''.$site_link.'/admin/manage-batchs.php');	
						}  	 
	 }else {
...
*/
		...
		/*  $sql = "INSERT INTO online_courses (`oc_name`, `oc_name_short`, `oc_orginal_fee`, `oc_discunt_fee`, `oc_discunt_percent`, `oc_date`)
						...
						echo reloader(''.$site_link.'/admin/manage-courses.php');	
						}  */
